    ...
    return (
        <div className="overflow-y-hidden mt-12">
            <div onMouseLeave={closeDrawer}>
                ...
                <div id="catalogDrawer"
                     className={`${handleDrawer()} w-full bg-pinkVolume flex justify-center p-8 transition relative z-10 duration-300 -mt-72 mb-52 drop-shadow-dark`}>
            ...
            {isLoading ? (
                ...
                <div id="catalogItemsContainer"
                     className={`${blurOnSearch()} -mt-32 transition duration-300 relative z-0`}>
                    Número de modelos:
