...
export default function ModelViewUI() {
    ...
    const author = state ? state.author.username : "Null User";
    ...
    return (
        <div
            id="mainModelViewUIContainer"
            className="md:w-[80%] w-full mt-14 font-loos animate-fade"
        >
            ...
            <div className="w-full px-32">
                ...
                <div
                    ...
                    className="h-[400px] w-full mx-auto inline-block bg-slate-300"
                >
                    <StlViewer
                ...
                <div id="modelInfoMainContainer" className="flex justify-between mt-4">
                    <div className="w-fit max-w-md">
                        <div id="userInfoContainer" className="flex gap-4 items-center">
                            ...
                            >
                                <div
                                    className="w-8 h-8 rounded-full bg-slate-400 hover:drop-shadow-slim cursor-pointer transition duration-300"></div>
                                <p className="LoosFont text-xl hover:underline cursor-pointer transition duration-300">
                                    {author}
                                </p>
                            </div>
                            <button
                                className="rounded-full px-10 py-[0.5px] border-2 border-black text-lg hover:bg-black hover:text-white transition duration-300">
                                Seguir
                            </button>
                        </div>
                        <div id="modelDescription" className="mt-4">
                            <p className="text-sm">
                                Jarrón con Diseño Exclusivo. Es posible la modificación del
                                color y el tamaño. El archivo ya contiene el STL.
                            </p>
                        </div>
                        <div id="cathegoryContainer" className="flex flex-wrap gap-2 mt-4">
                            <p className="w-fit text-black text-md bg-pinkVolume rounded-full px-8 py-2 hover:bg-pinkDarkVolume hover:text-white cursor-pointer transition duration-300">
                                Hogar
                            </p>
                            <p className="w-fit text-black text-md bg-pinkVolume rounded-full px-8 py-2 hover:bg-pinkDarkVolume hover:text-white cursor-pointer transition duration-300">
                                Decoración
                    ...
                    <div>
                        <div id="iconsContainer" className="flex gap-6 justify-center">
                            <div>
                                <svg
                                    ...
                                    strokeWidth={1.5}
                                    stroke="currentColor"
                                    className="w-6 h-6 mx-auto hover:fill-black cursor-pointer"
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                        ...
                        <div id="buttonsContainer" className="flex flex-col gap-4 mt-8">
                            <button
                                className="LoosFont px-6 py-2 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
                                Descargar Modelo
                            </button>
                            <button
                                className="LoosFont px-6 py-2 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
                ...
                <div id="exploreContainer" className="mt-24">
                    ...
                    <div className="mt-4 flex justify-end">
                        <button
                            className="LoosFont px-10 py-1 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
                            More
                        </button>
                    </div>
                </div>
