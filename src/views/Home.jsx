    ...
    <div className="w-3/5 h-[60vh] p-[20px] rounded-2xl bg-cyan-200 drop-shadow-darker justify-items-center">
      ...
      {isLoggedIn && (
          <div className="flex flex-wrap justify-center font-ubuntu text-white">
            ...
            <button className="px-14 py-8 w-[40%] m-[2%] text-[20px] rounded-2xl transition hover:scale-105 hover:shadow-dark-spread bg-gradient-to-br from-sky-400 to-blue-800" onClick={() => {navigate('/Volume/tutorials')}}>Tutorials</button>
