...
export default function CatalogItem(){
    ...
    return(
        <div className="w-full h-72 bg-slate-400 flex flex-shrink flex-col relative overflow-y-hidden cursor-pointer" onMouseEnter={openInfo} onMouseLeave={closeInfo}>
