      ...
      <div className="w-full px-32">
        ...
        <div id="modelInfoMainContainer" className="flex justify-between mt-4">
          <div className="w-fit max-w-md">
            <div id="userInfoContainer" className="flex gap-4 items-center">
              ...
              <button className="rounded-full px-10 py-[0.5px] border-2 border-black text-lg hover:bg-black hover:text-white transition duration-300">
                Seguir
              </button>
            </div>
          ...
          <div>
            ...
            <div id="buttonsContainer" className="flex flex-col gap-4 mt-8">
              <button className="LoosFont px-6 py-2 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
                Descargar Modelo
              </button>
              <button className="LoosFont px-6 py-2 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
                Solicitar Impresión
        ...
        <div id="exploreContainer" className="mt-24">
          ...
          <div className="mt-4 flex justify-end">
            <button className="LoosFont px-10 py-1 rounded-full text-lg bg-greenFooter hover:bg-green-900 hover:text-white transition duration-300">
              More
            </button>
          </div>
        </div>
